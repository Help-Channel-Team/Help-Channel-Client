...
exports.createTunnel = function(wsServerAddr, credentials, listen, forward,proxymode,agent, callback) {
  ...
  var server = net.createServer(function (tcpSock) {
    ...
    var url = 'wss://' + wsServerAddr + '/wsServer?port=' + forward.port + '&host=' + forward.host;
    console.log(url);
